...
admin.site.site_title = admin.site.site_header = 'nexus Administration'
...
urlpatterns += [
    ...
    # Django Admin
    re_path(r'^{}/'.format(settings.DJANGO_ADMIN_URL), admin.site.urls),
...
if settings.DEBUG:
    ...
    try:
        ...
        urlpatterns += [path('devrecargar/', include((devrecargar_urls, 'devrecargar', ), namespace='devrecargar'))]
    except ImportError:
        pass
