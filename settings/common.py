...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'nexus.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'nexus.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'nexus.base.exceptions.exception_handler',
}
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='nexus')
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='nexus@sanyamkhurana.com')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[nexus] ')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/nexus'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'nexus.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'nexus.base.views.csrf_failure'
